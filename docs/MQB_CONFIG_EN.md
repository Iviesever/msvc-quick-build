...
**Language: [简体中文](MQB_CONFIG.md) | English**
...
For the broader build/module/cache architecture, see [`ARCHITECTURE_EN.md`](ARCHITECTURE_EN.md). For stable self-hosting, see [`SELF_HOSTING_EN.md`](SELF_HOSTING_EN.md).
